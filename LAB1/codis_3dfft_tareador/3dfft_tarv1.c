...
int main (int argc, char *argv[]) {
    ...
    tareador_start_task("ffts1_planes1");
    ffts1_planes(p1d, in_fftw);
    tareador_end_task("ffts1_planes1");

    tareador_start_task("transpose_xy_planes1");
    transpose_xy_planes(tmp_fftw, in_fftw);
    tareador_end_task("transpose_xy_planes1");
    
    tareador_start_task("ffts1_planes2");
    ffts1_planes(p1d, tmp_fftw);
    tareador_end_task("ffts1_planes2");
    
    tareador_start_task("transpose_zx_planes1");    
    transpose_zx_planes(in_fftw, tmp_fftw);
    tareador_end_task("transpose_zx_planes1");

    tareador_start_task("ffts1_planes3");
    ffts1_planes(p1d, in_fftw);
    tareador_end_task("ffts1_planes3");
    
    tareador_start_task("transpose_zx_planes2");    
    transpose_zx_planes(tmp_fftw, in_fftw);
    tareador_end_task("transpose_zx_planes2");
    
    tareador_start_task("transpose_xy_planes2");
    transpose_xy_planes(in_fftw, tmp_fftw);
    tareador_end_task("transpose_xy_planes2");
